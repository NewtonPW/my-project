...
from models import db, Flower, Billing, User
import os
...
# ลบดอกไม้
@bp_admin.route('/delete_flower/<int:id>', methods=['POST'])
...
# แก้ไขดอกไม้
@bp_admin.route('/edit_flower/<int:id>', methods=['GET', 'POST'])
def edit_flower(id):
...
@bp_admin.route('/update_order_status/<int:bill_id>', methods=['POST'])
